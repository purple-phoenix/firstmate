...
An already existing legacy hold can still be retried without an options document; [`dashboard-service.md`](dashboard-service.md) owns how the dashboard presents and accepts answers for it.
