...
Only a canonical labeled declaration is monitored - a preview, visual-evidence, or feature-report label followed by a tailnet link - so transcripts and worked examples cannot become preview identities, at the deliberate cost of no longer monitoring a bare unlabeled URL.
