...
- The producer's first viewport is a four-question captain brief: what needs the captain now, who is active and doing what, what is stuck and why, and what shipped in the bounded recent-completion reading.
  ...
  Work, People, and Ideas pages keep recommendations, automatic waits, the pipeline manifest, the full live roster, lanes, definition health, recurring work, parking, landed history, and idea verdicts directly navigable without loading the brief with secondary detail.
