...
- A valid secondmate home is in scope; an idle secondmate endpoint with no armed inbound captain channel remains healthy because it has no supervision need.
