...
#   - Need: arms only while work is in flight (state/*.meta) or an inbound
#     captain channel has a poll to run; an idle home exits 0.
...
# --- need: in-flight work or an armed inbound captain channel ----------------
need_supervision() {
