...
- Only shared material is tracked: `AGENTS.md`, `README.md`, `CONTRIBUTING.md`, `.tasks.toml`, `.github/workflows/`, `bin/`, `.agents/skills/`, and `skills/`.
  ...
  A local `config/backlog-backend=manual` opt-out stays gitignored; [`docs/configuration.md`](docs/configuration.md) owns its manual-editing scope and validated exceptions.
